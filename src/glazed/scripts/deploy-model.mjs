...
await writeFile(new URL('../__generated__/aliases.ts', import.meta.url), `export const aliases = ${JSON.stringify(aliases)}`)

console.log('Model aliases written to src/glazed/__generated__/aliases.ts file:', aliases)
